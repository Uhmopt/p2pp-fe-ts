...
> = ({
	...
	const errorMessage = useMemo(() => field.errorMessage ?? "Please input correct phone number", [field.errorMessage]);
	...
	const renderValue = useMemo(() => ((value || "") as string).replaceAll(/./g, "*"), [value]);
	...
	return readOnly ? (
		...
		<div className="w-full" onClick={() => onClick(field)}>
			...
			<Grid container spacing={1} justifyContent="flex-end">
				...
				<Grid item>
					<Button onClick={handleGenerate} startIcon={<EnhancedEncryption />} variant="contained">
						Generate
					</Button>
				</Grid>
			</Grid>
